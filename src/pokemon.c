...
const u16 gSpeciesToHoennPokedexNum[NUM_SPECIES - 1] = // Assigns all species to the Hoenn Dex Index (Summary No. for Hoenn Dex)
{
...
const u16 gSpeciesToNationalPokedexNum[NUM_SPECIES - 1] = // Assigns all species to the National Dex Index (Summary No. for National Dex)
{
...
const u16 gHoennToNationalOrder[HOENN_DEX_COUNT - 1] = // Assigns Hoenn Dex Pokémon (Using National Dex Index)
{
